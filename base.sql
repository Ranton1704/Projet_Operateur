...
CREATE TABLE baremes_frais (
    ...
    promotion_pourcentage REAL NOT NULL DEFAULT 0.0,
    ...
    CHECK(frais >= 0),
    CHECK(promotion_pourcentage >= 0 AND promotion_pourcentage <= 100)
);
...
(2,10001,25000,200,0),
(2,25001,50000,400,0),
(2,50001,100000,800,0),
(2,100001,250000,1500,0),
(2,250001,500000,1500,0),
(2,500001,1000000,2500,0),
(2,1000001,2000000,3000,0),
...
(3,10001,25000,200,0),
(3,25001,50000,400,0),
(3,50001,100000,800,0),
(3,100001,250000,1500,0),
(3,250001,500000,1500,0),
(3,500001,1000000,2500,0),
(3,1000001,2000000,3000,0);
